...
'Verifying Email = george.bluth@reqres.in'
WS.verifyElementPropertyValue(response, 'data[0].email', 'george.bluth@reqres.in')

'Verifying First_name =  George'
WS.verifyElementPropertyValue(response, 'data[0].first_name', 'George')

'Verifying Last_name = Bluth'
WS.verifyElementPropertyValue(response, 'data[0].last_name', 'Bluth')

'Verifying Avatar = https://s3.amazonaws.com/uifaces/faces/twitter/calebogden/128.jpg'
WS.verifyElementPropertyValue(response, 'data[0].avatar', 'https://s3.amazonaws.com/uifaces/faces/twitter/calebogden/128.jpg')
